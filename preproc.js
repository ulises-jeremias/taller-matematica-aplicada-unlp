...
const codeEditableTemplate = (code, lang = 'haskell') => (`<pre><code class='lang-${lang} hljs' data-trim contenteditable>${escapeHtml(code)}
</code></pre>`)

const codeTemplate = (code, lang = 'haskell') => (`\`\`\`${lang}
${code}
\`\`\``)
